...
DATE_MAP = {
    ...
    f"{BASE_URL}/blog/isvec-secim-hileleri-valfusk-2026-hukuki-boyutlari/": "2026-09-23",
    f"{BASE_URL}/blog/isvec-gocmenlik-cin-operasyonlari-pekin-tasinma-rehberi/": "2026-09-22",
    f"{BASE_URL}/blog/isvec-secim-sonuclari-sonrasi-hukumet-kurma-sureci-ve-siyasi-dinamikler/": "2026-09-21",
    f"{BASE_URL}/blog/isvec-secim-sistemi-malmo-vekili-tartismasi-2026/": "2026-09-20",
    f"{BASE_URL}/blog/isvec-demokratlarinin-secim-kaybi-parti-ici-catismayi-tetikleyebilir-2026/": "2026-09-19",
    f"{BASE_URL}/blog/isvec-hukmet-kurma-krizi-c-ve-v-partileri-arasindaki-cikmaz-2026/": "2026-09-18",
    f"{BASE_URL}/blog/isvec-iskur-isizlik-raporu-agustos-2026/": "2026-09-17",
    f"{BASE_URL}/blog/isvec-2026-secimleri-valstudion-canli-yayin/": "2026-09-16",
    f"{BASE_URL}/blog/candy-crush-grev-kollektif-is-sozlesmesi-isvec/": "2026-09-15",
    f"{BASE_URL}/blog/isvec-secim-anketleri-2026-svt-valu-hatalari/": "2026-09-14",
    f"{BASE_URL}/blog/isvec-2026-secimleri-erken-oy-gecikmeleri/": "2026-09-13",
    f"{BASE_URL}/blog/isvec-2026-genel-secim-sonuclari-ne-zaman-aciklanacak/": "2026-09-12",
    f"{BASE_URL}/blog/isvec-siyasetinde-somurtuk-tartismasi-akesson-andersson/": "2026-09-11",
    f"{BASE_URL}/blog/isvecte-hukumet-kurma-sureci-2026-secimleri-sonrasi/": "2026-09-10",
    f"{BASE_URL}/blog/isvec-secim-2026-yapay-zeka-parti-manifestolari/": "2026-09-09",
    f"{BASE_URL}/blog/migrationsverket-yeni-iletisim-direktoru-eva-carlstedt/": "2026-09-08",
    f"{BASE_URL}/blog/isvec-emlak-vergisi-degerleri-dusuyor-2026/": "2026-09-07",
    f"{BASE_URL}/blog/trafikverket-yeni-ingilizce-istasyon-anonslari-isvec/": "2026-09-06",
    f"{BASE_URL}/blog/isvec-sol-parti-ve-sosyal-demokratlar-koalisyon-gorusmeleri/": "2026-09-05",
    f"{BASE_URL}/blog/isvecte-yukselen-enerji-fiyatlari-2026-kis-beklentileri/": "2026-09-04",
    f"{BASE_URL}/blog/isvec-insaat-sektorunde-skatteverketten-habersiz-denetimler-2026/": "2026-09-03",
    f"{BASE_URL}/blog/ulrika-karlsson-migrationsverket-yeni-basin-sozcusu/": "2026-09-02",
    f"{BASE_URL}/blog/migrationsverket-yeni-basin-sefi-ulrika-karlsson/": "2026-09-01",
    f"{BASE_URL}/blog/migrationsverket-yeni-basin-sefi-ulrika-karlsson/": "2026-08-31",
    f"{BASE_URL}/blog/ulrika-karlsson-migrationsverket-yeni-basin-muduru/": "2026-08-30",
    f"{BASE_URL}/blog/isvec-guvencesiz-calisanlar-hastalik-parasi-az-kullaniyor/": "2026-08-30",
    f"{BASE_URL}/blog/isvecte-issizlik-oranlari-dususte-2026-ikinci-ceyrek/": "2026-08-30",
    f"{BASE_URL}/blog/migrationsverket-yeni-basin-direktoru-ulrika-karlsson-atandi/": "2026-08-30",
    f"{BASE_URL}/blog/isvec-secim-kampanyasinda-antisemitizm-gerilimi/": "2026-08-29",
    f"{BASE_URL}/blog/isvec-guvencesiz-istihdam-ve-hastalik-odenegi/": "2026-08-29",
    f"{BASE_URL}/blog/isvec-issizlik-orani-azaliyor-2026-ikinci-ceyrek-analizi/": "2026-08-29",
    f"{BASE_URL}/blog/migrationsverket-yeni-basin-sorumlusu-ulrika-karlsson/": "2026-08-29",
    f"{BASE_URL}/blog/isvec-pedofili-ile-mucadele-kimyasal-hadim-edim-onerisi/": "2026-08-28",
    f"{BASE_URL}/blog/guvencesiz-istihdami-olanlar-isvecte-hastalik-parasini-daha-az-kullaniyor/": "2026-08-28",
    f"{BASE_URL}/blog/isvec-isizlik-orani-azaliyor-2026-ikinci-ceyrek/": "2026-08-28",
    f"{BASE_URL}/blog/migrationsverket-yeni-basin-sorumlusu-ulrika-karlsson-oldu/": "2026-08-28",
    f"{BASE_URL}/blog/isvec-issizlik-oranlari-ikinci-ceyrek-2026/": "2026-08-27",
    f"{BASE_URL}/blog/isvec-emeklilere-ek-vergi-kvarskatt-2026-odeme-rehberi/": "2026-08-27",
    f"{BASE_URL}/blog/migrationsverket-yeni-basin-muduru-ulrika-karlsson-atandi/": "2026-08-27",
    f"{BASE_URL}/blog/isvec-secimleri-2026-partilerin-politikalari-secmen-algisi/": "2026-08-26",
    f"{BASE_URL}/blog/isvec-guvencesiz-calisanlar-icin-hastalik-maasi-raporu-2026/": "2026-08-26",
    f"{BASE_URL}/blog/isvec-iskur-issizlik-raporu-ikinci-ceyrek-2026/": "2026-08-26",
    f"{BASE_URL}/blog/isvecte-emeklilere-kvarskatt-uyarisi-2026/": "2026-08-26",
    f"{BASE_URL}/blog/isvec-guvencesiz-istihdam-hastalik-odenegi-raporu/": "2026-08-25",
    f"{BASE_URL}/blog/isvec-emeklilerine-vergi-borcu-kvarskatt-2026/": "2026-08-25",
    f"{BASE_URL}/blog/yeni-isvec-vatandaslik-testi-basladi-istatistiklere-dikkat/": "2026-08-25",
    f"{BASE_URL}/blog/isvec-gundeminden-son-dakika-haberleri-24-agustos-2026/": "2026-08-24",
    f"{BASE_URL}/blog/isvec-2026-secimleri-liberalerna-icin-akessonun-ultimatumu/": "2026-08-24",
    f"{BASE_URL}/blog/isvec-emekli-kvarskatt-odeme-rehberi-2026/": "2026-08-24",
    f"{BASE_URL}/blog/isvec-vatandaslik-istatistikleri-migrationsverket-uyarisi/": "2026-08-24",
    f"{BASE_URL}/blog/isvec-2026-secimleri-rusya-hibrit-tehditleri-esti-uyarisi/": "2026-08-23",
    f"{BASE_URL}/blog/isvec-emeklilere-kvarskatt-uyarisi-2026/": "2026-08-23",
    f"{BASE_URL}/blog/isvec-vatandaslik-testi-bekleme-sureleri-ve-istatistikleri-migrationsverket-uyarisi/": "2026-08-23",
    f"{BASE_URL}/blog/fagersta-lise-saldirisi-detaylari-2026/": "2026-08-22",
    f"{BASE_URL}/blog/isvec-emeklilere-kvarskatt-odeme-rehberi-2026/": "2026-08-22",
    f"{BASE_URL}/blog/isvec-vatandaslik-istatistikleri-dikkatli-yorumlanmali-yeni-test-yasasi/": "2026-08-22",
    f"{BASE_URL}/blog/isvec-emekliler-icin-ek-vergi-ve-vergiden-kacinma-yollari-2026/": "2026-08-21",
    f"{BASE_URL}/blog/isvec-vatandaslik-istatistikleri-yeni-yasa-ve-sinav-etkisi/": "2026-08-21",
    f"{BASE_URL}/blog/isvec-temmuz-2026-issizlik-verileri-is-piyasasi-analizi/": "2026-08-20",
    f"{BASE_URL}/blog/isvec-kripto-para-vergi-beyannamesi-2026-yeni-duzenlemeler/": "2026-08-20",
    f"{BASE_URL}/blog/isvec-pensioner-kvarskatt-odeme-tarihleri-ve-onleme-yollari-2026/": "2026-08-20",
    f"{BASE_URL}/blog/isvec-vatandaslik-testi-bekleme-sureleri-goc-idaresi-uyarisi/": "2026-08-20",
    f"{BASE_URL}/blog/abd-icc-yaptirimlari-isvec-gocmenlik-etkileri/": "2026-08-19",
    f"{BASE_URL}/blog/isvec-kirsal-bolgeleri-gelecek-profesor-mellander-uyarilari-cozumler/": "2026-08-19",
    f"{BASE_URL}/blog/isvec-issizlik-orani-azaliyor-temmuz-2026/": "2026-08-19",
    f"{BASE_URL}/blog/isvec-kripto-para-vergi-beyani-2026-skatteverket-duyurusu/": "2026-08-19",
    f"{BASE_URL}/blog/isvec-vatandaslik-istatistikleri-yeni-yasa-sonrasi-dikkat/": "2026-08-19",
    f"{BASE_URL}/blog/isvec-faiz-artisi-beklentisi-2026/": "2026-08-18",
    f"{BASE_URL}/blog/isvec-modern-psikiyatri-hastaneleri-sd-onerisi/": "2026-08-18",
    f"{BASE_URL}/blog/isvec-issizlik-temmuz-2026-analizi/": "2026-08-18",
    f"{BASE_URL}/blog/isvec-kripto-para-vergi-beyannamesi-2026-skatteverket-duyurusu/": "2026-08-18",
    f"{BASE_URL}/blog/isvec-vatandaslik-istatistikleri-yeni-sinavlar-nedeniyle-dikkat/": "2026-08-18",
    f"{BASE_URL}/blog/isvec-adalet-sistemi-skandal-suc-isleyen-yargiclar-namndeman/": "2026-08-17",
    f"{BASE_URL}/blog/isvec-issizlik-orani-azaliyor-2026-temmuz/": "2026-08-17",
    f"{BASE_URL}/blog/isvec-kripto-para-vergi-beyani-2026-yeni-duzenlemeler/": "2026-08-17",
    f"{BASE_URL}/blog/isvec-iskur-issizlik-raporu-temmuz-2026/": "2026-08-16",
    f"{BASE_URL}/blog/isvec-kripto-vergi-beyaninda-yeni-donem-skatteverket-raporu-ve-guncel-kurallar/": "2026-08-16",
    f"{BASE_URL}/blog/isvec-secim-2026-borclanma-dususu/": "2026-08-15",
    f"{BASE_URL}/blog/isvec-issizlik-orani-azaliyor-2026-temmuz/": "2026-08-15",
    f"{BASE_URL}/blog/isvecte-kripto-para-vergilendirmesi-skatteverket-2026/": "2026-08-15",
    f"{BASE_URL}/blog/isvec-rus-casusluk-operasyonu-svt-detaylari/": "2026-08-14",
    f"{BASE_URL}/blog/isvec-yeni-tasarruf-komisyonu-kamu-harcamalarinda-etkinlik/": "2026-08-14",
    f"{BASE_URL}/blog/isvec-issizlik-orani-azaliyor-2026-temmuz/": "2026-08-14",
    f"{BASE_URL}/blog/isvecte-kripto-para-beyani-2026-yeni-duzenlemeler/": "2026-08-14",
    f"{BASE_URL}/blog/isvec-goc-hukuk-politikalarinda-son-gelismeler-2026/": "2026-08-13",
    f"{BASE_URL}/blog/isvec-issizlik-orani-temmuz-2026-Arbetsformedlingen/": "2026-08-13",
    f"{BASE_URL}/blog/isvec-kripto-para-vergi-beyannamesi-2026/": "2026-08-13",
    f"{BASE_URL}/blog/isvec-2026-secimleri-val-kampanyasi-svt-ozel-yayini/": "2026-08-12",
    f"{BASE_URL}/blog/isvec-gunes-tutulmasi-gozlukleri-tükendi/": "2026-08-12",
    f"{BASE_URL}/blog/anders-sandin-pensionsmyndigheten-yeni-mudur/": "2026-08-12",
    f"{BASE_URL}/blog/isvec-gida-fiyatlari-2026-sonbahar-rekor-sicakliklar/": "2026-08-11",
    f"{BASE_URL}/blog/anders-sandin-pensionsmyndigheten-yeni-bolum-baskani/": "2026-08-11",
    f"{BASE_URL}/blog/isvec-gundemi-10-agustos-gecenin-haberleri/": "2026-08-10",
    f"{BASE_URL}/blog/isvec-bogulma-kazalari-azaldi-2026-temmuz/": "2026-08-10",
    f"{BASE_URL}/blog/anders-sandin-pensionsmyndigheten-atama/": "2026-08-10",
    f"{BASE_URL}/blog/akesson-sd-secmenleri-ve-hukumet-hedefi-2026/": "2026-08-09",
    f"{BASE_URL}/blog/anders-sandin-pensionsmyndigheten-konut-ve-gelir-destegi-departmani-baskani/": "2026-08-09",
    f"{BASE_URL}/blog/bebeklerde-anne-karninda-gastroschisis-ameliyati-isvec-perspektifi/": "2026-08-08",
    f"{BASE_URL}/blog/isvec-pensionsmyndigheten-anders-sandin-atama/": "2026-08-08",
    f"{BASE_URL}/blog/kebnekaise-kaya-dusmeleri-iklim-degisikligi-tehdidi/": "2026-08-07",
    f"{BASE_URL}/blog/anders-sandin-pensionsmyndigheten-konut-gelir-destegi-muduru/": "2026-08-07",
    f"{BASE_URL}/blog/isvec-iklim-haberciligi-kutuplasma-anket-svt-2026/": "2026-08-06",
    f"{BASE_URL}/blog/isvec-halkinin-iklim-degisikligi-algisi-svt-anketi-2026/": "2026-08-06",
    f"{BASE_URL}/blog/pensionsmyndigheten-anders-sandin-yeni-gorev/": "2026-08-06",
    f"{BASE_URL}/blog/isveclilerin-yarisi-asiri-sicaklar-nedeniyle-avrupa-tatilinden-vazgeciyor/": "2026-08-05",
    f"{BASE_URL}/blog/anders-sandin-pensionsmyndigheten-yeni-mudur-2026/": "2026-08-05",
    f"{BASE_URL}/blog/isvec-2026-secim-kampanyasi-basladi-m-ve-s-farkli-konumlarda/": "2026-08-04",
    f"{BASE_URL}/blog/isvec-iklim-degisikligi-orman-yanginlari-anket-2026/": "2026-08-04",
    f"{BASE_URL}/blog/isvec-cetesi-lideri-emin-muqa-kulic-ispanyada-yakalandi/": "2026-08-03",
    f"{BASE_URL}/blog/sas-norvec-grevi-500-kabin-calisani-grevde/": "2026-08-03",
    f"{BASE_URL}/blog/isvec-enformasyon-yukumlulugu-yasasi-ilk-uc-hafta/": "2026-08-02",
    f"{BASE_URL}/blog/isvec-ceza-reformu-mangdrabatt-iptali-gecikiyor/": "2026-08-02",
    f"{BASE_URL}/blog/isvec-sosyal-sigortalar-kanunu-degisiklikleri-2026/": "2026-08-02",
    f"{BASE_URL}/blog/isvec-dodshopp-ekstrem-dalisi/": "2026-08-01",
    f"{BASE_URL}/blog/isvec-goc-tahminleri-temmuz-2026-ukrayna-calisma-vatandaslik/": "2026-07-31",
    f"{BASE_URL}/blog/isvec-tjorn-tekne-kazasi-uzman-uyarilari/": "2026-07-30",
    f"{BASE_URL}/blog/migrationsverket-temmuz-2026-goc-prognosu/": "2026-07-30",
    f"{BASE_URL}/blog/isvec-ekonomisi-guncel-durum-temmuz-2026/": "2026-07-29",
    f"{BASE_URL}/blog/isvec-norrland-siddetli-yagmur-uyarisi-smhi-2026/": "2026-07-29",
    f"{BASE_URL}/blog/isvec-gocmenlik-idaresi-temmuz-2026-tahminleri/": "2026-07-29",
    f"{BASE_URL}/blog/jonas-falk-2-5-ton-kokain-davasi-isvec-vatandaslik-tartismasi/": "2026-07-28",
    f"{BASE_URL}/blog/jonas-falk-isvec-uyusturucu-suclari-gocmenlik-etkileri/": "2026-07-28",
    f"{BASE_URL}/blog/isvec-gocmenlik-temmuz-2026-prognosu/": "2026-07-28",
    f"{BASE_URL}/blog/isvecte-orman-yangini-alarmi-smhi-kritik-uyari/": "2026-07-27",
    f"{BASE_URL}/blog/migrationsverket-temmuz-2026-goc-tahminleri/": "2026-07-27",
    f"{BASE_URL}/blog/isvec-geri-donus-yardimi-sorunu-2026/": "2026-07-26",
    f"{BASE_URL}/blog/migrationsverket-temmuz-2026-gocmenlik-tahminleri/": "2026-07-26",
    f"{BASE_URL}/blog/isvec-genc-suc-kiralik-tetikci-hizmet-olarak-suc-diamant-salihu/": "2026-07-25",
    f"{BASE_URL}/blog/isvec-temmuz-2026-gocmenlik-prognosu-ukraynali-korumasi-vatandaslik-degisiklikleri/": "2026-07-25",
    f"{BASE_URL}/blog/isvec-haziran-2026-issizlik-oranlari-guncel-analiz/": "2026-07-24",
    f"{BASE_URL}/blog/isvec-yeni-nesil-asirilik-siddet-icin-siddet/": "2026-07-24",
    f"{BASE_URL}/blog/isvec-goc-idaresi-temmuz-2026-goc-tahminleri/": "2026-07-24",
    f"{BASE_URL}/blog/isvec-yaz-sicaklari-geri-donuyor-hava-durumu-tahmini/": "2026-07-23",
    f"{BASE_URL}/blog/isvecin-onde-gelen-rusya-uzmani-martin-kragh-hayatini-kaybetti/": "2026-07-23",
    f"{BASE_URL}/blog/isvec-issizlik-oranlari-haziran-2026-prognosu/": "2026-07-23",
    f"{BASE_URL}/blog/isvec-tbe-kene-vakalarinda-rekor-artis-2026/": "2026-07-22",
    f"{BASE_URL}/blog/isvec-sosyal-guvenlik-yasasi-degisiklikleri-temmuz-2026/": "2026-07-22",
    f"{BASE_URL}/blog/isvec-issizlik-orani-haziran-2026-dususu/": "2026-07-22",
    f"{BASE_URL}/blog/iklim-degisiklikleri-ve-avrupa-sicaklari/": "2026-07-21",
    f"{BASE_URL}/blog/isvec-issizlik-orani-haziran-2026-arbeidsformedlingen-raporu/": "2026-07-21",
    f"{BASE_URL}/blog/isvec-issizlik-oranlari-2026-haziran-guncel/": "2026-07-20",
    f"{BASE_URL}/blog/isvec-ikamet-izni-vandel-sartlari-2026/": "2026-07-20",
    f"{BASE_URL}/blog/facebook-kesintisi-isvec-2026/": "2026-07-19",
    f"{BASE_URL}/blog/isvec-issizlik-raporu-haziran-2026-olumlu-gelismeler/": "2026-07-19",
    f"{BASE_URL}/blog/isvec-oturma-izni-vandel-gereksinimleri-2026/": "2026-07-19",
    f"{BASE_URL}/blog/isvec-issizlik-orani-haziran-2026/": "2026-07-18",
    f"{BASE_URL}/blog/isvec-oturma-izni-vandel-kriterleri-sikilastirildi/": "2026-07-18",
    f"{BASE_URL}/blog/isvec-iskur-isizlik-verileri-haziran-2026/": "2026-07-17",
    f"{BASE_URL}/blog/isvec-mevsimlik-calisma-izni-2026/": "2026-07-17",
    f"{BASE_URL}/blog/isvec-oturma-izni-iyi-hal-durustluk-kosullari-2026/": "2026-07-17",
    f"{BASE_URL}/blog/isvec-aile-tatilinde-beklentiler-ve-cocuklarla-iletisim-rehberi/": "2026-07-16",
    f"{BASE_URL}/blog/isvec-issizlik-orani-haziran-2026-dususte/": "2026-07-16",
    f"{BASE_URL}/blog/isvec-sezonluk-calisma-izni-2026-guncel-duyuru/": "2026-07-16",
    f"{BASE_URL}/blog/isvec-oturma-izni-skartade-krav-2026/": "2026-07-16",
    f"{BASE_URL}/blog/isvec-rezervasyon-sitesi-dolandiriciligina-dikkat-2026/": "2026-07-15",
    f"{BASE_URL}/blog/isvec-sezonluk-calisma-izni-2026-guncel-duyurular-ve-kosullar/": "2026-07-15",
    f"{BASE_URL}/blog/isvec-oturma-izni-vandel-kurallari-sikilastirildi-2026/": "2026-07-15",
    f"{BASE_URL}/blog/isvec-tur-koruma-listesi-yeniden-duzenleniyor-kirpi-yilan-baligi-koruma/": "2026-07-14",
    f"{BASE_URL}/blog/avrupada-trenle-seyahat-rehberi-per-j-andersson-ipuclari/": "2026-07-14",
    f"{BASE_URL}/blog/isvec-mevsimlik-calisma-izni-2026-guncel-duyuru/": "2026-07-14",
    f"{BASE_URL}/blog/isvec-gocmenlik-vandel-sartlari-sikilastirildi/": "2026-07-14",
    f"{BASE_URL}/blog/isvec-askerlikte-kadin-katilimi-hedeflerden-uzaklandi/": "2026-07-13",
    f"{BASE_URL}/blog/isvec-varnplikti-kadinlarin-askerlik-hayali-ve-artan-rekabet/": "2026-07-13",
    f"{BASE_URL}/blog/isvec-sezonluk-calisma-izni-2026-guncel-duyuru/": "2026-07-13",
    f"{BASE_URL}/blog/isvec-oturma-izni-vandel-sartlari-sertlesti/": "2026-07-13",
    f"{BASE_URL}/blog/isvec-cocuk-genclerde-obezite-ilaclari-subvansiyon-tartismasi/": "2026-07-12",
    f"{BASE_URL}/blog/isvec-gocmenlik-hukuku-yeni-duzenlemeler-2026/": "2026-07-12",
    f"{BASE_URL}/blog/isvec-mevsimlik-calisma-izni-2026/": "2026-07-12",
    f"{BASE_URL}/blog/isvec-cocuk-obezite-ilaci-subvansiyonu/": "2026-07-11",
    f"{BASE_URL}/blog/isvec-11-temmuz-gece-haberleri-ozeti/": "2026-07-11",
    f"{BASE_URL}/blog/isvec-gocmenlik-yasasi-degisiklikleri-temmuz-2026/": "2026-07-11",
    f"{BASE_URL}/blog/isvec-mevsimlik-calisma-izinleri-2026-guncel-rehber/": "2026-07-11",
    f"{BASE_URL}/blog/bad-bunny-isvec-konseri-duygusal-kulturel-kopru/": "2026-07-10",
    f"{BASE_URL}/blog/google-pricerunner-davasi-isvec-rekabet-ihlali-dma/": "2026-07-10",
    f"{BASE_URL}/blog/isvec-gocmenlik-yasalarinda-yeni-duzenlemeler-2026/": "2026-07-10",
    f"{BASE_URL}/blog/isvec-sezonluk-calisma-izni-2026-guncel-duyuru/": "2026-07-10",
    f"{BASE_URL}/blog/sas-ceosu-air-canadaya-geciyor/": "2026-07-09",
    f"{BASE_URL}/blog/isvec-hukumetine-yonelik-tehdit-sapo-sorusturuyor/": "2026-07-09",
    f"{BASE_URL}/blog/isvec-vaxholm-feribotu-yangini-yolcu-tahliyesi/": "2026-07-08",
    f"{BASE_URL}/blog/fransa-isvec-askeri-takviye-nato-boden/": "2026-07-08",
    f"{BASE_URL}/blog/isvec-sosyal-guvenlik-yasalarinda-guncellemeler-2026/": "2026-07-08",
    f"{BASE_URL}/blog/isvec-gida-fiyatlari-dususu-devam-ediyor-haziran-2026/": "2026-07-07",
    f"{BASE_URL}/blog/isvec-yeni-vab-kurallari-okul-toplantilari-sosyal-hizmetler-egitim/": "2026-07-07",
    f"{BASE_URL}/blog/isvec-sosyal-sigorta-degisiklikleri-1-temmuz-2026/": "2026-07-07",
